...
import com.zrp.mallplus.sys.mapper.SysRoleMapper;
import com.zrp.mallplus.sys.mapper.SysRolePermissionMapper;
import com.zrp.mallplus.sys.service.ISysRolePermissionService;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService {
    ...
    @Transactional
    @Override
    public boolean updateSysRole(Long roleId,List<Long> menuIds) {
        updatePermissions(roleId, menuIds);
        return true;
    }
