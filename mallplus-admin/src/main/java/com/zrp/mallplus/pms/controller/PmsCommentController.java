    ...
    public Object getPmsCommentByPage(PmsComment entity,
        ...
        try {
            if (entity.getContent()!=null&&!entity.getContent().equals("")){
                return new CommonResult().success(IPmsCommentService.page(new Page<PmsComment>(pageNum, pageSize), new QueryWrapper<PmsComment>().like("content",entity.getContent())));
            }
