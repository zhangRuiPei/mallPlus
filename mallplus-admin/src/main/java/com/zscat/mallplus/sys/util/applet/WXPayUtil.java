package com.zscat.mallplus.sys.util.applet;
...
public class WXPayUtil {
     ...
     * @return String
     */
    public static String mapToXml(Map<Object, Object> data) {
        Element root=new Element("xml");
        Document doc=new Document();
        for(Object k:data.keySet()) {
            Element child=new Element(k.toString());
     ...
     * @return 含有sign字段的XML
     */
    public static String generateSignedXml(final Map<Object, Object> data, String key) {
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        Map<Object, Object> data = xmlToMap(xmlStr);
        if (!data.containsKey(WXPayConstants.SIGN) ) {
            return false;
        }
        String sign = data.get(WXPayConstants.SIGN).toString();
     ...
     * @throws Exception
     */
    public static boolean isSignatureValid(Map<Object, Object> data, String key) throws Exception {
        if (!data.containsKey(WXPayConstants.SIGN) ) {
            return false;
        }
        String sign = data.get(WXPayConstants.SIGN).toString();
     ...
     * @return 签名
     */
    public static String generateSignature(final Map<Object, Object> data, String key) {
