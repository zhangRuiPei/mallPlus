...
import com.zscat.mallplus.sys.util.CharUtil;
import com.zscat.mallplus.sys.util.MapUtils;
import com.zscat.mallplus.sys.util.XmlUtil;
...
/*    private static Map<Object, Object> buildRequsetMapParam(String out_trade_no, BigDecimal bdOrderMoney, BigDecimal bdRefundMoney) {
        ...
        Class<? extends WechatRefundApiResult> aClass = new WechatRefundApiResult().getClass();
