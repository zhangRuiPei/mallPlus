...
public class PmsBrandController {
    ...
    public Object getPmsBrandByPage(PmsBrand entity,
        ...
        try {
            if (ValidatorUtils.notEmpty(entity.getName())&&!entity.getName().equals("")) {
                return new CommonResult().success(IPmsBrandService.page(new Page<PmsBrand>(pageNum, pageSize), new QueryWrapper<PmsBrand>(new PmsBrand()).like("name", entity.getName()).orderByDesc("sort")));
            }
            return new CommonResult().success(IPmsBrandService.page(new Page<PmsBrand>(pageNum, pageSize), new QueryWrapper<PmsBrand>().orderByDesc("sort")));
        } catch (Exception e) {
