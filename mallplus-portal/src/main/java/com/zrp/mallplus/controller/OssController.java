...
import com.zrp.mallplus.service.impl.OssServiceImpl;
...
public class OssController {
    ...
    public Object uploadImage(Long groupId,@RequestPart("file") MultipartFile multipartFile) {
    ...
    public Object uploadImages(Long groupId,  @RequestPart("file") MultipartFile[] multipartFile) {
        List<BlobUpload> list = new ArrayList<>();
    ...
    public Object uploadFile(Long groupId,  String fileType,  @RequestPart("file") MultipartFile multipartFile) {
        List<BlobUpload> list = new ArrayList<>();
