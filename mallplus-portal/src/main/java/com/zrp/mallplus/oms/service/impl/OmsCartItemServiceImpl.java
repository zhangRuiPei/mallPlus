...
import com.zrp.mallplus.oms.vo.CartProduct;
import com.zrp.mallplus.oms.vo.CartPromotionItem;
import com.zrp.mallplus.pms.entity.PmsProduct;
import com.zrp.mallplus.pms.entity.PmsProductFullReduction;
...
import com.zrp.mallplus.pms.vo.PromotionProduct;
...
public class OmsCartItemServiceImpl extends ServiceImpl<OmsCartItemMapper, OmsCartItem> implements IOmsCartItemService {
    ...
    public OmsCartItem add(OmsCartItem cartItem) {
        ...
        if (org.apache.commons.lang.StringUtils.isBlank(cartItem.getPic())) {
