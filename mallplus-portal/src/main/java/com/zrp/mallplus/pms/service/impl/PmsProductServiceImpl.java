...
import com.zrp.mallplus.cms.service.ICmsPrefrenceAreaProductRelationService;
...
import com.zrp.mallplus.pms.mapper.*;
import com.zrp.mallplus.pms.service.*;
import com.zrp.mallplus.pms.vo.GoodsDetailResult;
...
import com.zrp.mallplus.sms.entity.SmsPaimaiLog;
import com.zrp.mallplus.sms.mapper.SmsGroupMapper;
import com.zrp.mallplus.sms.mapper.SmsGroupMemberMapper;
import com.zrp.mallplus.sms.mapper.SmsPaimaiLogMapper;
import com.zrp.mallplus.sms.service.ISmsHomeBrandService;
import com.zrp.mallplus.sms.service.ISmsHomeNewProductService;
import com.zrp.mallplus.sms.service.ISmsHomeRecommendProductService;
import com.zrp.mallplus.sys.mapper.SysStoreMapper;
...
import com.zrp.mallplus.ums.service.impl.RedisUtil;
...
public class PmsProductServiceImpl extends ServiceImpl<PmsProductMapper, PmsProduct> implements IPmsProductService {
    ...
    @Override
    public List<PmsProduct> listfindByCategoryId(Long productCategoryId){
        System.out.println(productCategoryId);
        System.out.println(productMapper.listfindByCategoryId(productCategoryId));
        return productMapper.listfindByCategoryId(productCategoryId);
    }


    @Override
    public List<PmsProduct> findProduct(PmsProduct pmsProduct) {
        return productMapper.findProduct(pmsProduct);
    }


    @Override
    public PageInfo findProductAndPage(PmsProduct pmsProduct, Page page) {
        PageHelper.startPage(page.getPageNum(),page.getPageSize());
        return new PageInfo(productMapper.findProduct(pmsProduct));
    }
