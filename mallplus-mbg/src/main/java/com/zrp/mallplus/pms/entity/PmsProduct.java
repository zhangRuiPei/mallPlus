...
import com.zrp.mallplus.vo.timeline.TimeSecound;
...
public class PmsProduct extends BaseEntity implements Serializable {
     ...
     * 运费方式 （1-统一收费；2-运费模板）
     * */
    @TableField("transfee_method")
    private Integer transfeeMethod;
     ...
     * 分销比例
     * */
    @TableField("distribution_ratio")
    private String distributionRatio;

    @TableField(exist = false)
    private List<PmsSkuStock> skustockList;
    @TableField(exist = false)
    private List<PecArr> pecarrs;
    @TableField(exist = false)
